...
public class LoginTestSupervisor extends BaseTest {

	@BeforeTest
	public void initSetup()
	{
		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		int rowNumber_TC = excel.getCellRowNum("TestCases", "TestCases", "LoginTestSupervisor");
		String testCaseName = excel.getCellData("TestCases", "TestCases", rowNumber_TC);
		System.out.println("test case name in @BeforeTest .LoginTestSupervisor..."+testCaseName);
		
		String runmode_TC = excel.getCellData("TestCases", "Runmode", rowNumber_TC);
		System.out.println("run mode in test case name @BeforeTest ..LoginTestSupervisor..."+runmode_TC);
	...
	public void LoginTestSupervisor(Hashtable<String,String> data) {

		ExcelReader excel = new ExcelReader(Constants.SUITE1_XL_PATH);
		DataUtil.checkExecution("master", "LoginTestSupervisor", data.get("Runmode"), excel);
		log.info("Inside Login Test Supervisor");
